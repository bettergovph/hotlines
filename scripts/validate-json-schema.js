...
if (args.length < 2) {
  ...
  console.error('  node validate-json-schema.js <schema-path> <file1> <file2> ...\n');
  console.error('Examples:');
  console.error('  node validate-json-schema.js schema.json "data/*.json"');
  console.error('  node validate-json-schema.js schema.json file1.json file2.json');
  process.exit(1);
}
...
console.log(`Validating ${uniqueFiles.length} file(s) against ${basename(schemaPath)}...\n`);
